    ...
    return (
        <div>
            <section className="moduel1head">
                <h1>Complete The Six Steps Below In Order To Start Making Money On We <span style={{color:'#1473bf'}}> P</span>itch Today!</h1>
            </section>
            <section className="moduel1list">
            <h2>You are curruently at<span style={{color:'#1473bf'}}> 0% </span>Completed</h2>
            ...
            <h3>How To : Close This Menu > Add profile Photo <br/>
            ...
            <section className="module1foot">
                <li><h1>Have A Question?</h1></li>
                <li><Button>Visit Support</Button></li>
            </section>
        </div>
    )
}
